...
def _(df_6):
    ...
    columnas_a_seleccionar = columnas_a_seleccionar + ['Momento', '¿Se promueven los procesos de metacognición y reflexión?', 'Al cierre de la clase ¿Se hace uso de algún tipo de gráfico de anclaje o memoria colectiva?', 'Nombre de docente observado/a']
